...
> **Importante:** o foco do projeto (conforme instrução da FIAP) foi **exclusivamente a criação da ideia, protótipo no Figma, modelagem de dados e elaboração de um vídeo pitch de 3 minutos ([assista aqui](https://youtu.be/dwEGXdfLups))**, e **não** o desenvolvimento técnico de um sistema completo.  
> O prazo total para a elaboração do projeto foi de **duas semanas**.
...
O **Storm Tracker** é uma plataforma web projetada para conectar cidadãos, órgãos públicos e dados meteorológicos em um único ecossistema colaborativo e inteligente.
...
<div align=center>
  <img src="https://github.com/user-attachments/assets/a0c98d68-a205-4886-8d0f-44f7962c2327" width="1010px" alt"Login">
  <img src="https://github.com/user-attachments/assets/8a10df65-1daa-4ad7-a74d-5df648600ab5" width="1010px" alt"Cadastro">
  <img src="https://github.com/user-attachments/assets/a5e74bcd-fb2e-48d1-91c9-d00eaf490427" width="1010px" alt"Mapa interativo">
  <img src="https://github.com/user-attachments/assets/3e2976f7-9df0-41ed-ba4f-b8a17bdaea77" width="1010px" alt"Relatar ocorrência">
  <img src="https://github.com/user-attachments/assets/99afd83e-c14f-4d4d-ad65-df180ff2a1b9" width="1010px" alt"Usuário autoridade">
</div>
...
![ST_Logical](https://github.com/user-attachments/assets/5b3cbc2d-d7ad-460e-a9e7-7527f1fa6fc8)
![ST_Relational](https://github.com/user-attachments/assets/a1605720-6c6e-485b-86cf-d27237052f3e)
